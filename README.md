...
Antares Tester changelog can be found in release notes [antaresproject.io/docs/site/getting_started/changelog/#tester](http://antaresproject.io/docs/site/getting_started/changelog/index.html#tester).
